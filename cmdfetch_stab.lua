...
local                 usedLines = {"Name","Kernel","OS","Memory","Uptime",
                      ...
                      usedLines = {"OS","Kernel","Uptime","WM","Resolution","Visual Style","bbLean Theme","Font","Music Player","Now Playing","IRC Client","CPU","GPU","Memory","Processes"}
...
local             lineFunctions = {}
    ...
    logos["windows7"]["colors"] = {"\027[1;31m","\027[1;32m","\027[1;33m","\027[1;34m"}
